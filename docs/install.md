...
[Download GamePulse-Friend-Setup-0.4.13.exe](https://github.com/ppgnox/gameflipz-native-releases/releases/download/v0.4.13/GamePulse-Friend-Setup-0.4.13.exe)

You can also open the release page first:

[GamePulse 0.4.13 release](https://github.com/ppgnox/gameflipz-native-releases/releases/tag/v0.4.13)
